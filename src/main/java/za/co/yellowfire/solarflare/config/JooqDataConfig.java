...
import za.co.yellowfire.solarflare.jooq.ExceptionTranslator;
import za.co.yellowfire.solarflare.jooq.SpringTransactionProvider;

import javax.sql.DataSource;

@Configuration
public class JooqDataConfig {
